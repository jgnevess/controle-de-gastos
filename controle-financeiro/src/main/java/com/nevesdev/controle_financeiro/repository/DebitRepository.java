...
public interface DebitRepository extends JpaRepository<Debit, Long> {
    ...
    @Query(value = "SELECT * FROM debit WHERE user_id = :userId and due_date >= :start", nativeQuery = true)
    List<Debit> findAllByUserIdAndDueDate(UUID userId, LocalDateTime start);
}
